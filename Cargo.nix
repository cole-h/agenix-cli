    ...
    crates = {
      ...
      "age" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "a28c8ec5cd8e6db65fb2133c2d188fb643d6562b";
          sha256 = "134mrrkwidlm2xrbbfr9a4zrpfc3chfbjp3fsb7mv8w9pmb74690";
        };
        authors = [
      ...
      "bcrypt-pbkdf" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "1dahg8z2v3cns14cvgc7mz0li2g1vvcxb1c8n5lljq9xdkjbpmbh";
        authors = [
          "RustCrypto Developers"
        ];
        dependencies = [
      ...
      "fluent" = rec {
        ...
        version = "0.14.3";
        edition = "2018";
        sha256 = "01kd6bc246k02rc5gq6k470l6h05cgaaiy0jm0rkw5bsy635v2qp";
        authors = [
      ...
      "fluent-bundle" = rec {
        ...
        version = "0.14.3";
        edition = "2018";
        sha256 = "0van30yxzv12jxs73w7z24z5fii7kqwrnqpvv487ppkq18rfvfgj";
        authors = [
          "Zibi Braniecki <gandalf@mozilla.com>"
          "Staś Małolepszy <stas@mozilla.com>"
        ];
      ...
      "fluent-syntax" = rec {
        ...
        edition = "2018";
        crateBin = [];
        sha256 = "13hi1bvpzrs9pdi3gqhwdkc7flb659m472d2jq5x0cfj0l0wd0v3";
        authors = [
          "Zibi Braniecki <gandalf@mozilla.com>"
          "Staś Małolepszy <stas@mozilla.com>"
        ];
      ...
      "i18n-config" = rec {
        ...
        version = "0.4.0";
        edition = "2018";
        sha256 = "0l42iv3pc5vppld62gp1ncabyq7376qhn8yvqr336bljk9n8yvaw";
        authors = [
      ...
      "i18n-embed" = rec {
        ...
        version = "0.10.2";
        edition = "2018";
        sha256 = "1b70aqbq6q8a96axr0dg3mhx7n9n27rq31wrm25bxbxc60krn3w2";
        authors = [
          "Luke Frisken <l.frisken@gmail.com>"
        ];
        dependencies = [
      ...
      "i18n-embed-fl" = rec {
        ...
        version = "0.3.1";
        edition = "2018";
        sha256 = "02zxg300gy2kgfv7s08jplnb8vd3yl0fw64c2cmk2cf68j2rigmq";
        procMacro = true;
        authors = [
          "Luke Frisken <l.frisken@gmail.com>"
        ];
      ...
      "i18n-embed-impl" = rec {
        ...
        version = "0.6.1";
        edition = "2018";
        sha256 = "11lzbyv6wbkja4hmcg3vw0qqll206fjc0c9kvpwff22s3wcvskga";
        procMacro = true;
        authors = [
          "Luke Frisken <l.frisken@gmail.com>"
        ];
      ...
      "ouroboros" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "0a9smaa8sy60lcx88vkm5rgjjzmbizfa85brpibs6iga034nddmh";
        authors = [
      ...
      "ouroboros_macro" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "069ny8inl19kzhfp2wy45x39iwpm8nfkcx1wj8aw9bf00pr1iinz";
        procMacro = true;
        authors = [
          "Joshua Maros <joshua-maros@github.com>"
        ];
      ...
      "pbkdf2" = rec {
        ...
        version = "0.6.0";
        edition = "2018";
        sha256 = "0jjaapyawm5iqn97mmfj40dvipsy78cm80qcva28009l2zbw1f5k";
        authors = [
          "RustCrypto Developers"
        ];
        dependencies = [
      ...
      "scrypt" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "1fgdmjdjx3lj92nswkxrq9nlv4vv7livg83nfybmv4izn3d9594d";
        authors = [
          "RustCrypto Developers"
        ];
        dependencies = [
